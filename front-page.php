			...
			<?php if (have_posts()) :
				...
				<div class="home-columns clearfix">
					...
					<div class="one-half">
						...
						<h2>Latest Lorem Ipsum</h2>
						
						<?php // Lorem Ipsum posts loop begins here
						...
						<span class="horiz-center"><a href="<?php echo get_category_link(5); ?>" class="btn-a">View all Lorem Ipsum Posts</a></span>
